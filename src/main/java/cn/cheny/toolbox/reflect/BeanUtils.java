...
public class BeanUtils {
    ...
    public static Map<String, Object> beanToMap(Object bean) {
        ...
        for (String property : methodHolder.getReadablePropertyNames()) {
            try {
    ...
    public static void copyProperties(Object target, Object source, String... ignoreProperties) {
        ...
        Collection<String> targetProperties = targetMethodHolder.getWritablePropertyNames();
        Collection<String> sourceProperties = sourceMethodHolder.getReadablePropertyNames().stream()
